...
module Refinery
  module Enquetes
    class Enquete < Refinery::Core::BaseModel
      ...
      attr_accessible :code_bnpv, :date_recueil, :doublon, :j_evenement, :m_evenement, :a_evenement, :comm_evenement, :gravite, :evolution, :j_evolution, :m_evolution, :a_evolution, :commentaire, :position, :patient_attributes
