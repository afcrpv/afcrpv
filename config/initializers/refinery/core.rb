...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Association Française des Centres Régionaux de Pharmacovigilance"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-20156445-5"
  ...
  # config.dragonfly_secret = "afd786815af49c2939039a348049b8c1473af0ac5f3de112"
